<!-- Standalone ROS2 Jazzy port: scope, reproducible setup, input/output contracts and limitations. -->
...
[THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) 和 [移植说明](docs/PORTING.md)。
...
结果间隔、内存和 CPU。测试结果与未通过指标见 [验证记录](docs/VALIDATION.md)。
